...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_ImageReviewOptions_To_scanner_ImageReviewOptions,
		Convert_scanner_ImageReviewOptions_To_v1alpha1_ImageReviewOptions,
...
func autoConvert_v1alpha1_ImageReviewOptions_To_scanner_ImageReviewOptions(in *ImageReviewOptions, out *scanner.ImageReviewOptions, s conversion.Scope) error {
	out.Image = in.Image
	out.Namespace = in.Namespace
	out.ImagePullSecrets = *(*[]string)(unsafe.Pointer(&in.ImagePullSecrets))
	return nil
}

// Convert_v1alpha1_ImageReviewOptions_To_scanner_ImageReviewOptions is an autogenerated conversion function.
func Convert_v1alpha1_ImageReviewOptions_To_scanner_ImageReviewOptions(in *ImageReviewOptions, out *scanner.ImageReviewOptions, s conversion.Scope) error {
	return autoConvert_v1alpha1_ImageReviewOptions_To_scanner_ImageReviewOptions(in, out, s)
}

func autoConvert_scanner_ImageReviewOptions_To_v1alpha1_ImageReviewOptions(in *scanner.ImageReviewOptions, out *ImageReviewOptions, s conversion.Scope) error {
	out.Image = in.Image
	out.Namespace = in.Namespace
	out.ImagePullSecrets = *(*[]string)(unsafe.Pointer(&in.ImagePullSecrets))
	return nil
...
// Convert_scanner_ImageReviewOptions_To_v1alpha1_ImageReviewOptions is an autogenerated conversion function.
func Convert_scanner_ImageReviewOptions_To_v1alpha1_ImageReviewOptions(in *scanner.ImageReviewOptions, out *ImageReviewOptions, s conversion.Scope) error {
	return autoConvert_scanner_ImageReviewOptions_To_v1alpha1_ImageReviewOptions(in, out, s)
}
